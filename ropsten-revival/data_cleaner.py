...
if __name__ == "__main__":
    ...
    print("Cleaned numeric:", clean_numeric_data(numeric_data))import numpy as np
import pandas as pd
...
if __name__ == "__main__":
    ...
    is_valid, message = validate_dataframe(cleaned_df, ['user_name', 'age', 'email_address'])
