...
if __name__ == "__main__":
    ...
    print(f"\nData Summary - Shape: {summary['shape']}")import numpy as np
import pandas as pd
...
def example_usage():
    ...
    print(f"Feature_a stats - Mean: {clean_df['feature_a'].mean():.2f}, Std: {clean_df['feature_a'].std():.2f}")
...
def sample_data_cleaning():
    ...
    sample_data = {
        ...
        'Email Address': ['john@example.com', 'jane@example.com', 'jane@example.com', 'bob@example.com', 'alice@example.com']
    }
    ...
    validation = validate_data(cleaned_df, required_columns=['user_id', 'first_name'])
    print("\nValidation Results:")
