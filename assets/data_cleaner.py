...
if __name__ == "__main__":
    ...
    stats = get_summary_statistics(cleaned_data, ['feature1', 'feature2', 'feature3'])
...
if __name__ == "__main__":
    ...
    sample_df.loc[10:15, 'temperature'] = 100
    sample_df.loc[20:25, 'humidity'] = 150
    
    columns_to_process = ['temperature', 'humidity', 'pressure']
    
    cleaned_data, statistics = process_dataframe(sample_df, columns_to_process)
