...
def clean_dataset(data, numerical_columns, outlier_method='iqr', normalize_method='minmax'):
    """
...
def validate_data(data, required_columns, allow_nulls=True):
    """
    Validate dataset structure and content
    """
    missing_columns = [col for col in required_columns if col not in data.columns]
    ...
    if not allow_nulls:
        ...
        if columns_with_nulls:
            raise ValueError(f"Columns contain null values: {columns_with_nulls}")
