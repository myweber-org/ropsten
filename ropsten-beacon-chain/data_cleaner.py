...
if __name__ == "__main__":
    ...
    filled_df = cleaner.fill_missing_mean(['feature1', 'feature2'])
    cleaner.df = filled_df
    
    normalized_df = cleaner.normalize_minmax(['feature1', 'feature2', 'feature3'])
...
if __name__ == "__main__":
    ...
    removed = cleaner.remove_outliers_iqr(['temperature', 'humidity', 'pressure'])
    print(f"Removed {removed} outliers")
    
    cleaner.fill_missing_median()
    print("Missing values after:", cleaner.df.isnull().sum().sum())
    
    cleaner.normalize_minmax(['temperature', 'humidity', 'pressure'])
