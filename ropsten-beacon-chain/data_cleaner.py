...
if __name__ == "__main__":
    sample_data = {
        'id': [1, 2, 2, 3, 4, 4],
        'value': [10.5, None, 15.3, 20.1, None, 25.0],
    ...
    cleaned = clean_dataframe(df, drop_duplicates=True, fill_missing={'value': 0, 'category': 'Unknown'})
    
    print("\nCleaned DataFrame:")
    print(cleaned)
    
    if validate_dataframe(cleaned, required_columns=['id', 'value']):
