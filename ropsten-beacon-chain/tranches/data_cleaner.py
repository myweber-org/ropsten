...
def validate_data(dataframe, required_columns):
...
if __name__ == "__main__":
    ...
    print("Sample dataset created with 100 records (including 5 outliers)")
    ...
    original_stats = calculate_basic_stats(sample_data, 'values')
    cleaned_stats = calculate_basic_stats(cleaned_data, 'values')
