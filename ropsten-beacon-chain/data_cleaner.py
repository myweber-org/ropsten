...
def sample_data_cleaning():
    ...
    cleaned = clean_dataframe(df, remove_duplicates=True, fill_missing=True, fill_value=0)
...
def clean_dataset(df, drop_duplicates=True, handle_nulls='drop', null_threshold=0.5):
    ...
    if handle_nulls == 'drop':
        ...
        print(f"Filled null values with median (numeric) and 'Unknown' (categorical)")
        ...
        cleaned_df = cleaned_df.dropna()
        print(f"Dropped remaining rows with null values")
