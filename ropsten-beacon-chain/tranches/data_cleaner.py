...
def main():
    ...
    is_valid, message = validate_dataframe(cleaned, required_columns=['id', 'value'], min_rows=1)
    print(f"\nValidation: {message}")
...
def process_numerical_data(df, columns=None):
    ...
    Parameters:
    df (pd.DataFrame): Input DataFrame
    columns (list): List of column names to process (default: all numerical columns)
