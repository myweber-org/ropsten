...
if __name__ == "__main__":
    ...
    print("Cleaning process completed.")import pandas as pd
import numpy as np
...
def clean_dataset(data, numeric_columns, outlier_removal=True, normalization='minmax', missing_strategy='mean'):
...
if __name__ == "__main__":
    ...
    numeric_cols = ['A', 'B', 'C']
    cleaned = clean_dataset(sample_data, numeric_cols, outlier_removal=True, normalization='zscore')
...
def clean_dataset(df, z_threshold=3, fill_method='median'):
    """
...
if __name__ == "__main__":
    ...
    # Clean data
    cleaned = clean_dataset(df, z_threshold=2.5, fill_method='median')
    print("Cleaned DataFrame:")
    print(cleaned)
    print()
...
if __name__ == "__main__":
    ...
    print("Cleaned data shape:", cleaned_df.shape)import numpy as np
import pandas as pd
