...
if __name__ == "__main__":
    ...
    print(f"\nOutliers removed: {100 - len(result_df)} data points")
import pandas as pd
import numpy as np
...
if __name__ == "__main__":
    ...
    print(f"Cleaned data saved to {output_file}")import pandas as pd
import numpy as np
...
if __name__ == "__main__":
    ...
    print(df)
    print("\nCleaned DataFrame:")
    cleaned_df = clean_dataset(df, outlier_removal=True, normalization=True)
    print(cleaned_df)
import pandas as pd
import numpy as np
