...
if __name__ == "__main__":
    ...
    print("Original statistics for feature_a:", calculate_statistics(sample_data, 'feature_a'))
    
    cleaned = clean_dataset(sample_data, ['feature_a', 'feature_b'])
    print("Cleaned data shape:", cleaned.shape)
    print("Cleaned statistics for feature_a:", calculate_statistics(cleaned, 'feature_a'))
import pandas as pd
import numpy as np
...
def validate_dataset(df, check_duplicates=True, check_missing=True):
    ...
    Parameters:
    df (pd.DataFrame): DataFrame to validate.
    check_duplicates (bool): Whether to check for duplicates. Default is True.
