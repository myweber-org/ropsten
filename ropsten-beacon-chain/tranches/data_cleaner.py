...
def normalize_data(df, columns=None, method='minmax'):
    ...
    for col in columns:
        if col in df.columns and method == 'minmax':
            min_val = df[col].min()
            max_val = df[col].max()
            if max_val != min_val:
                df_normalized[col] = (df[col] - min_val) / (max_val - min_val)
        
        elif col in df.columns and method == 'zscore':
...
if __name__ == "__main__":
    ...
    print("\nSummary statistics:")
    print(calculate_summary_statistics(sample_data))
    
    cleaned_data = remove_outliers_iqr(sample_data)
    print("\nCleaned data shape:", cleaned_data.shape)
    
    normalized_data = normalize_data(cleaned_data, method='minmax')
    print("\nNormalized data sample:")
    print(normalized_data.head())import pandas as pd
import numpy as np
