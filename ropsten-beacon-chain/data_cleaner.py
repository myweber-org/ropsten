...
if __name__ == "__main__":
    ...
    sample_data.loc[1001] = {'values': -100}
    ...
    print("Cleaned statistics:", calculate_statistics(cleaned, 'values'))
import pandas as pd
import numpy as np
...
if __name__ == "__main__":
    ...
    print(f"\nData validation: {'PASS' if is_valid else 'FAIL'}")import numpy as np
import pandas as pd
from scipy import stats
...
def process_dataset(file_path):
    ...
    print(f"Missing values filled: {df.isnull().sum().sum() - missing_filled.isnull().sum().sum()}")
    
    outliers_removed = cleaner.remove_outliers_iqr()
    print(f"Outliers removed: {outliers_removed}")
    
    normalized_df = cleaner.normalize_zscore()
    print(f"Data normalized using Z-score")
...
if __name__ == "__main__":
    ...
    print(calculate_statistics(cleaned, 'feature_a'))import numpy as np
import pandas as pd
from scipy import stats
...
if __name__ == "__main__":
    ...
    sample_data.loc[::100, 'feature1'] = 500
    sample_data.loc[::150, 'feature2'] = 300
    ...
    summary = summarize_cleaning(sample_data, cleaned_data, ['feature1', 'feature2', 'feature3'])
