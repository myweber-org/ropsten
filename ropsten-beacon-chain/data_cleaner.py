...
if __name__ == "__main__":
    ...
    print("Original value range:", df['value'].min(), "to", df['value'].max())
    
    cleaned_df = clean_numeric_data(df, columns=['value'])
    
    print("Cleaned DataFrame shape:", cleaned_df.shape)
    print("Cleaned value range:", cleaned_df['value'].min(), "to", cleaned_df['value'].max())
    
    is_valid = validate_dataframe(cleaned_df, required_columns=['id', 'value', 'category'])
    print("Data validation passed:", is_valid)
import pandas as pd
import numpy as np
from scipy import stats
...
if __name__ == "__main__":
    ...
    is_valid = validate_dataframe(cleaned, ['first_name', 'last_name', 'age'])
