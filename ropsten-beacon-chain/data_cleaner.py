...
if __name__ == "__main__":
    ...
    cleaned = clean_dataset(df, drop_duplicates=True, fill_missing={'value': 0, 'category': 'Unknown'})
    print("Cleaned DataFrame:")
    print(cleaned)
    print()
...
if __name__ == "__main__":
    ...
    print("Cleaned statistics:", calculate_basic_stats(cleaned_data, 'values'))import pandas as pd
...
def clean_numeric_column(dataframe, column_name, fill_method='mean'):
    ...
    return dataframeimport numpy as np
import pandas as pd
...
if __name__ == "__main__":
    ...
    print(f"Removed outliers: {len(df) - len(result_df)}")
    print("\nCleaned data summary:")
    print(result_df[['feature1_normalized', 'feature2_normalized']].describe())