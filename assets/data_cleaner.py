...
if __name__ == "__main__":
    ...
    sample_data = {
        ...
        'department': ['Sales', 'IT', 'IT', 'HR', 'Sales', 'IT', 'IT']
    }
...
def main():
    ...
    sample_data.loc[0, 'value'] = 10  # Add an outlier
...
def clean_dataset(df, outlier_factor=1.5, normalize=True, missing_strategy='mean'):
    cleaner = DataCleaner(df)
    ...
    print(f"Handled missing values using {missing_strategy} strategy")
    ...
    return cleaner.get_clean_data(), summary